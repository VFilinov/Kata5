...
int MainCmds::testgpuerror(const vector<string>& args) {
  ...
  try {
    ...
    cmd.addModelFileArg();
    TCLAP::ValueArg<string> boardSizeDatasetArg("","boardsize", "Dataset to benchmark on (15,19,15x19,rectangle), default 15", false, "15", "SIZE");
    ...
    if(boardSizeDataset == "19") {
      defaultNNXSize = 19;
      defaultNNYSize = 19;
    } else if(boardSizeDataset == "15") {
      defaultNNXSize = 15;
      defaultNNYSize = 15;
    } else if(boardSizeDataset == "15x19") {
      defaultNNXSize = 15;
      defaultNNYSize = 19;
