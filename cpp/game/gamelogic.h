...
namespace GameLogic {
  ...
  bool isForbidden(const Board& board, Loc loc);
  bool isForbiddenAlreadyPlayed(const Board& board, Loc loc);
  bool checkAlreadyWin(const Board& board, const BoardHistory& hist, Player pla, Loc loc);
