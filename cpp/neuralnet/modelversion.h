...
namespace NNModelVersion {
  enum VersionMode { SUPPORTED_VERSION, DOUBLE_POLICY_CHANELLS, IS_MULTIPLIER, SOFTPLUS_MODE, TYPE_VCN_RULE, SELECT_ACTIVATION, IS_TIME_LEFT, NONLINEARITY_PASS_POLICY };
