...
def main(rank: int, world_size: int, args, multi_gpu_device_ids, readpipes, writepipes, barrier):
    ...
    num_all_epochs = num_epochs_this_instance

    epochjsonpath = os.path.join(traindir,"model_epoch.json")
    if os.path.exists(epochjsonpath):
      with open(epochjsonpath,"r") as f:
        dataepoch = json.load(f)
        num_all_epochs = dataepoch["epoch"]
        f.close();
    ...
    while True:
        ...
        logging.info("=========================================================================")
        logging.info("BEGINNING NEXT EPOCH " + str(num_all_epochs))
        logging.info("=========================================================================")
